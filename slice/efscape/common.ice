...
#include <arrowice/ArrowService.ice>

/**
 * Defines the casm (formerly efscape) interface, a interface for a DEVS-based simulation
 * services, for an Internet Connection Environment (ICE)-based framework.
 *
 * @author Jon C. Cline <jon.c.cline@gmail.com>
 * @version 2.0.0 created 06 Dec 2006, revised 19 May 2018
 */
[["js:es6-module"]]
module efscape {
  ...
  struct Content {
    string port;
    arrowice::ArrowTable value;
  };

  sequence<Content> ContentList;
